...
public class TI32Result implements org.apache.thrift.TBase<TI32Result, TI32Result._Fields>, java.io.Serializable, Cloneable, Comparable<TI32Result> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TI32Result");
  ...
  static {
    schemes.put(StandardScheme.class, new TI32ResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TI32ResultTupleSchemeFactory());
    schemes.put(TupleBinaryScheme.class, new TI32ResultTupleBinarySchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TI32Result.class, metaDataMap);
  }
   ...
   */
  public TI32Result(TI32Result other) {
  ...
  public TI32Result deepCopy() {
    return new TI32Result(this);
  }
  ...
  public TI32Result setError(int error) {
    this.error = error;
    setErrorIsSet(true);
    return this;
  }
  ...
  public TI32Result setValue(int value) {
    this.value = value;
    setValueIsSet(true);
    return this;
  }
  ...
  public TI32Result setExtData(String extData) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TI32Result)
      return this.equals((TI32Result)that);
    return false;
  }

  public boolean equals(TI32Result that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TI32Result other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TI32Result(");
    boolean first = true;
  ...
  private static class TI32ResultStandardSchemeFactory implements SchemeFactory {
    public TI32ResultStandardScheme getScheme() {
      return new TI32ResultStandardScheme();
    }
  }

  private static class TI32ResultStandardScheme extends StandardScheme<TI32Result> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TI32Result struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TI32Result struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TI32ResultTupleSchemeFactory implements SchemeFactory {
    public TI32ResultTupleScheme getScheme() {
      return new TI32ResultTupleScheme();
    }
  }

  private static class TI32ResultTupleScheme extends TupleScheme<TI32Result> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TI32Result struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TI32Result struct) throws org.apache.thrift.TException {
  ...
  private static class TI32ResultTupleBinarySchemeFactory implements SchemeFactory {
    public TI32ResultTupleBinaryScheme getScheme() {
      return new TI32ResultTupleBinaryScheme();
    }
  }

  private static class TI32ResultTupleBinaryScheme extends TupleBinaryScheme<TI32Result> {
